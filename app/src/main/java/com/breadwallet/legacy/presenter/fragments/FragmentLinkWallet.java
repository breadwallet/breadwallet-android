...
public class FragmentLinkWallet extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            domains.setTypeface(ResourcesCompat.getFont(getContext(), R.font.roboto_bold));
            ...
            capabilitiesTextView.setTypeface(ResourcesCompat.getFont(getContext(), R.font.roboto_regular));
