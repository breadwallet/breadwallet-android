...
public class MainFragmentEmpty extends Fragment implements QRCodeReaderView.OnQRCodeReadListener {
    ...
    private MainFragmentEmpty decoderFragment;

    public MainFragmentEmpty() {
    ...
    private class CameraOpenerTask extends AsyncTask {
        ...
        protected Object doInBackground(Object[] params) {
            if (mydecoderview == null) {
                mydecoderview = (QRCodeReaderView) getView().findViewById(R.id.qrdecoderview);
