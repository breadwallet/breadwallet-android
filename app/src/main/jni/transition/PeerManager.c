...
JNIEXPORT void Java_com_breadwallet_wallet_BRPeerManager_connect(JNIEnv *env, jobject thiz,
                                                                 ...
                                                                 jlong peersCount) {
    _globalEnv = env;
    _peerManagerInstance = thiz;
    _peerManagerClass = (*_globalEnv)->GetObjectClass(_globalEnv, _peerManagerInstance);
